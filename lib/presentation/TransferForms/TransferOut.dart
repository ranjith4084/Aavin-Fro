...
class TransferOutForm extends StatefulWidget {
  @override
  _TransferOutFormState createState() => _TransferOutFormState();
}

class _TransferOutFormState extends State<TransferOutForm> {
  List formLength=["0"];
  String productID = "";
                                ...
                                onPressed: () async {
                                 // Map temp={};
                                  if (_formKey.currentState.validate()) {
                                    await _ref.collection("TransferOut").add({
                                      "FromParlour":_vm.storedetails.storeCode,
                                      "ToParlour":toParlourID,
                                      "Products":dataMap,
                                      "Date": dateTime
                                    });
                                    ...
                                    await _ref.collection("InventoryChanges").doc(_vm.storedetails.storeCode).update(temp);
